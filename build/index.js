...
function edit({
  ...
  const [data, setData] = (0,react__WEBPACK_IMPORTED_MODULE_4__.useState)(Array.from({
    length: attributes.rows
  }, () => Array(attributes.cols).fill("")));
  const rows = Array.from({
    length: attributes.rows
  }, (_, i) => i);
  const cols = Array.from({
    length: attributes.cols
  }, (_, i) => i);
  ...
  const tableData = rows.map(row => (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("tr", {
    children: cols.map(col => (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("td", {
  ...
  const tableData = rows.map(row => (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("tr", {
    children: cols.map(col => (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("td", {
      children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", {
        children: attributes.data[row][col]
      })
    }))
  }));
...
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"dotcamp/tableberg","version":"0.0.0","title":"Tableberg","category":"table","icon":"table-row-after","description":"Tableberg: table builder Gutenberg block","attributes":{"cols":{"type":"number","default":5},"rows":{"type":"number","default":3},"data":{"type":"array","default":[]}},"supports":{"html":false},"textdomain":"tableberg","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./style-main"], () => (__webpack_require__("./src/index.tsx")))

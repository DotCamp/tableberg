...
class Common {
	 ...
	 */
	public function generate_star_display( $value, $limit, $id, $inactive_star_color, $active_star_color = '#eeee00',
			$star_outline_color = '#000000', $class_name = '', $mask_name = '', $size = 20 ) {
		$stars = '';
